...
export const IndustryDiscoveryBar: React.FC<IndustryDiscoveryBarProps> = ({
  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 px-3 py-2 shadow-2xs flex items-center gap-2 overflow-hidden">
      {/* Label */}
      <div className="flex items-center gap-1.5 text-xs font-bold text-slate-700 shrink-0 pr-1.5 border-r border-slate-200/80">
      ...
      <div className="flex items-center gap-1.5 overflow-x-auto no-scrollbar py-0.5 w-full">
        ...
        <button
          ...
          className={`h-7 px-3 rounded-lg text-xs font-semibold whitespace-nowrap transition-all shrink-0 flex items-center gap-1.5 cursor-pointer select-none ${
            currentIndustry === 'all'
